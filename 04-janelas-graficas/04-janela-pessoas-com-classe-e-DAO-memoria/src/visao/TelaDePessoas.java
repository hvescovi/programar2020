...
public class TelaDePessoas extends JFrame {
	...
	public TelaDePessoas() {
		...
		// popular o cadastro: criar pessoas e inserir no DAO
		...
		dadosTabela.addRow(new String[] {p1.getNome(), p1.getEmail(), p1.getTelefone()});
		dadosTabela.addRow(new String[] {p2.getNome(), p2.getEmail(), p2.getTelefone()});
		dadosTabela.addRow(new String[] {p3.getNome(), p3.getEmail(), p3.getTelefone()});
	}
}